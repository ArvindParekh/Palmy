...
import { LayoutDashboard, FileText, Users, FlaskConical, Trophy, Settings, Sparkles } from "lucide-react"
...
export function AppSidebar({ currentView, onNavigate }: AppSidebarProps) {
  return (
    <Sidebar variant="inset" className="border-r border-neutral-200 dark:border-neutral-800">
      <SidebarHeader className="p-6 border-b border-neutral-200 dark:border-neutral-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="font-semibold text-neutral-900 dark:text-white">Templates</h1>
            <p className="text-xs text-neutral-500">Job application toolkit</p>
          </div>
        </div>
      </SidebarHeader>
