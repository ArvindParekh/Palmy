...
export function TemplateCard({ 
  ...
  const colorClasses = {
    sage: {
      ...
      accent: 'bg-emerald-200/90 text-emerald-900 border-emerald-300/80 dark:bg-emerald-900/60 dark:text-emerald-200 dark:border-emerald-700/40',
      icon: 'text-emerald-800 dark:text-emerald-300',
      ring: 'ring-emerald-500/20 dark:ring-emerald-400/20',
    },
    lavender: {
      gradient: 'from-purple-100/95 via-violet-100/85 to-purple-200/75 dark:from-purple-950/40 dark:via-violet-950/30 dark:to-purple-900/20',
      accent: 'bg-purple-200/90 text-purple-900 border-purple-300/80 dark:bg-purple-900/60 dark:text-purple-200 dark:border-purple-700/40',
      icon: 'text-purple-800 dark:text-purple-300',
      ring: 'ring-purple-500/20 dark:ring-purple-400/20',
    },
    cream: {
      gradient: 'from-amber-100/95 via-yellow-100/85 to-amber-200/75 dark:from-amber-950/40 dark:via-yellow-950/30 dark:to-amber-900/20',
      accent: 'bg-amber-200/90 text-amber-900 border-amber-300/80 dark:bg-amber-900/60 dark:text-amber-200 dark:border-amber-700/40',
      icon: 'text-amber-800 dark:text-amber-300',
      ring: 'ring-amber-500/20 dark:ring-amber-400/20',
    },
    pearl: {
      gradient: 'from-slate-100/95 via-gray-100/85 to-slate-200/75 dark:from-slate-950/40 dark:via-gray-950/30 dark:to-slate-900/20',
      accent: 'bg-slate-200/90 text-slate-900 border-slate-300/80 dark:bg-slate-900/60 dark:text-slate-200 dark:border-slate-700/40',
      icon: 'text-slate-800 dark:text-slate-300',
      ring: 'ring-slate-500/20 dark:ring-slate-400/20',
    },
    stone: {
      gradient: 'from-stone-100/95 via-neutral-100/85 to-stone-200/75 dark:from-stone-950/40 dark:via-neutral-950/30 dark:to-stone-900/20',
      accent: 'bg-stone-200/90 text-stone-900 border-stone-300/80 dark:bg-stone-900/60 dark:text-stone-200 dark:border-stone-700/40',
      icon: 'text-stone-800 dark:text-stone-300',
      ring: 'ring-stone-500/20 dark:ring-stone-400/20',
    },
    mist: {
      gradient: 'from-blue-100/95 via-sky-100/85 to-blue-200/75 dark:from-blue-950/40 dark:via-sky-950/30 dark:to-blue-900/20',
      accent: 'bg-blue-200/90 text-blue-900 border-blue-300/80 dark:bg-blue-900/60 dark:text-blue-200 dark:border-blue-700/40',
  ...
  return (
    <div className="group relative w-full rounded-3xl bg-white/90 dark:bg-slate-900/80 backdrop-blur-lg border border-gray-200/50 dark:border-slate-700/50 shadow-xl hover:shadow-2xl hover:shadow-black/5 dark:hover:shadow-black/30 transition-all duration-500 cursor-pointer overflow-hidden">
      {/* Gradient background */}
      <div className={cn("absolute inset-0 bg-gradient-to-br opacity-50 group-hover:opacity-70 transition-opacity duration-500", colors.gradient)} />
      ...
      <div className="relative z-10 p-8">
        ...
        {tags.length > 0 && (
          <div className="flex flex-wrap gap-2 mb-6">
            ...
            {tags.length > 3 && (
              <Badge variant="secondary" className="backdrop-blur-sm bg-white/80 dark:bg-slate-800/60 text-gray-800 dark:text-gray-200 border-gray-300/50 dark:border-slate-600/30">
                +{tags.length - 3}
              </Badge>
            )}
          </div>
