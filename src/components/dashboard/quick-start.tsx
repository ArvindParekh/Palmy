    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
      {actions.map((action) => (
        <Link href={action.href} key={action.title}>
          <div className="group relative h-full bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-xl p-6 transition-all hover:border-blue-500/50 hover:shadow-lg">
            <div className="flex items-center gap-4 mb-4">
              ...
              <h3 className="text-lg font-semibold text-neutral-900 dark:text-white">{action.title}</h3>
            </div>
